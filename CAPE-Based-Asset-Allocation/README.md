...
- Performed regression analysis on 1-year and 5-year forward returns.
- Built a dynamic asset allocation model using valuation-based allocation bands.
- Compared historical performance against a static 60/40 benchmark.
